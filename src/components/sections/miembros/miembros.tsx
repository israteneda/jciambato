            ...
            <div className="max-w-6xl mx-8 lg:mx-auto">
                ...
                <header className="text-start mb-12">
                    ...
                    <p className="text-lg text-gray-600 mt-2 max-w-3xl">
                        Los miembros de la JCI Ambato son jóvenes de entre 18 y 40 años, parte de organizaciones locales, comprometidos con su desarrollo como líderes y ciudadanos activos. Su objetivo es generar un impacto positivo en sus comunidades mediante la participación en proyectos y actividades que fomentan el crecimiento en liderazgo, emprendimiento, acción comunitaria y cooperación internacional.

                        En esencia, los integrantes de la JCI son jóvenes apasionados por su desarrollo personal y por construir un mundo mejor, contribuyendo activamente tanto en su comunidad como en la organización.
                    </p>
                </header>
