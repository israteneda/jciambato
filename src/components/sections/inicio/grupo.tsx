...
export default function Grupo() {
  return (
    <section className="relative z-10 overflow-hidden">
      <div>
        <div className="z-10 flex relative justify-end h-[calc(20px+34.375vw)]"> {/* 215px */}
          <Image
            src="/images/grupo3.jpeg"
            alt="Grupo JCI Ambato"
            width={500}
            height={500}
            className="absolute top-0 right-0 w-[55vw] h-full object-cover"
          />
        </div>
        ...
        <div className="-mt-¨[336px] lg:-mt-52">
          ...
          <div className="relative z-10 bg-transparent w-[1156px] mx-auto">
            ...
            <div className="text-[13px] leading-[1.85] uppercase text-[rgb(152,152,152)] font-bold tracking-normal">
              Grupo JCI Ambato
            </div>
            <div className="mt-6">
              <h3 className="text-[48px] font-bold normal-case text-[rgb(219,0,41)] leading-[1.33] tracking-normal max-w-[calc(75%)] text-left sm:text-[calc(28.8px+1vw)]">
                A lo largo de mas de 50 años, JCI Ambato a fomentado del desarrollo de líderes en la ciudad.
              </h3>
            </div>
          </div>
          ...
          <div className="relative z-10 bg-transparent w-[1156px] mx-auto">
            <div className="relative flex">
              {/* Descripción */}
              <div className="flex-1 grow shrink basis-0 ml-16 sm:ml-[64px]">
                <div className="mt-8">
                  <div className="text-[18px] font-normal normal-case leading-[1.78] tracking-normal text-[rgb(50,50,50)] text-left max-w-[333px] lg:text-[calc(15.6px+0.125vw)]">
                ...
                <div className="mt-12">
                  <Button
                    radius="none"
                    variant="bordered"
                    className="border-gray-400 text-gray-400 group"
                    aria-label="Conoce nuestra misión y visión"
                  >
                    <span className="absolute inset-0 transform -translate-x-full bg-gray-400 transition-transform duration-300 group-hover:translate-x-0" />
                    <span className="relative z-10 transition-colors duration-300 group-hover:text-white">
              ...
              <div className="flex-1 grow shrink basis-0">
              ...
              {/* Estadisticas */}
              <div className="flex-1 grow shrink basis-0 mt-[120px]">
                <div className="flex flex-wrap mr-28">

                  <div className="flex-none w-full md:w-[50%] mt-[48px] ml-[25px] box-border">
                    <div className="text-[rgb(219,0,41)] text-[calc(44px+3.125vw)] leading-[1] tracking-[-5px] font-light">
                      <span>+34</span>
                    </div>
                    <div className="text-[calc(13.6px+0.125vw)] text-left max-w-[180px] uppercase leading-[1.5] tracking-normal">
                      <p><strong>Miembros</strong> dentro del capítulo</p>
                    </div>
                  </div>

                  <div className="flex-1 grow shrink basis-0 w-[50%] mt-[48px] ml-[25px] box-border">
                    <div className="text-[rgb(219,0,41)] text-[calc(44px+3.125vw)] leading-[1] font-light tracking-[-5px] ">
                      <span>~1,350</span>
                    </div>
                    <div className="text-[calc(13.6px+0.125vw)] text-left max-w-[180px] uppercase leading-[1.5] tracking-normal">
                      <p><strong>Miembros</strong> dentro del capítulo</p>
