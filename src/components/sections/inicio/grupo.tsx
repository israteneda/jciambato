  ...
  <div className="mx-11 xl:mx-0 md:w-4/6">
    ...
    <div className="max-w-md mt-8 ml-10 md:ml-16">
      <p className="text-base md:text-lg text-gray-700">
        Nos comprometemos a construir un legado de cambio que beneficie a nuestras comunidades y
        fomente el crecimiento colectivo.
      </p>
...
const Stadistycs = () => (
  <div className="mx-11 w-full md:w-1/2 mt-16">
    ...
    <div className="text-left">
      <p className="text-7xl md:text-8xl font-light text-cyan-600">20+</p>
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-10 md:gap-5 mt-10 md:mt-16">
      <div className="text-left">
        <p className="text-7xl sm:text-8xl font-light text-cyan-600">50+</p>
        <p className="text-base text-gray-700 font-semibold uppercase">Años en Ambato</p>
      </div>
      <div className="text-left">
        <p className="text-7xl sm:text-8xl font-light text-cyan-600">20+</p>
