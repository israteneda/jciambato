            ...
            <div className="md:mr-48">
              ...
              <div className="mt-8">
                <div className="text-medium font-normal not-italic leading-[1.78] tracking-normal text-[rgb(50,50,50)] text-left md:max-w-[470px]">
                  Learn more about Martifer's growth story, which turned it into the multinational
                  industrial group that it is today. Martifer was founded in 1990 and is today the
                  holding company of the Group. It has been listed on Euronext Lisbon since June
                  2007.
                </div>
              </div>
            </div>
