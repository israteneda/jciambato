...
export default function ActividadesAnuales() {
    return (
        <section className="relative z-10 md:my-32">
            <div>
                <BackgroundText
                    textoPrimario="We always"
                    textoSecundario="look back"
                    numberLeft={0.1}
                    numberRight={0.1}
                />
            </div>
                        ...
                        <div className="md:mr-48">
                            <div className="mt-20">
                                <h3 className="text-4xl md:text-5xl font-bold not-italic text-left leading-[1.17] tracking-normal text-black md:max-w-[470px]">
                                    30 years of great achievements
                                </h3>
                            </div>
                            <div className="mt-8">
                                <div className="text-medium font-normal not-italic leading-[1.78] tracking-normal text-[rgb(50,50,50)] text-left md:max-w-[470px]">
                                    Learn more about Martifer's growth story, which turned it into the multinational industrial group that it is today. Martifer was founded in 1990 and is today the holding company of the Group. It has been listed on Euronext Lisbon since June 2007.
                                </div>
                            </div>
                        </div>
                    </div>
