              ...
              <div className="">
                ...
                <div className="mt-8">
                  <h3 className="text-3xl md:text-[48px] font-aeonik-bold font-bold leading-[1.33] text-black max-w-[862px] text-left sm:text-[calc(28.8px+1vw)]">
                    Exceeding expectations, Martifer is a synonym of achievement, quality, trust and
                    differentiation in the solutions and services it provides to its clients.
                  </h3>
                </div>

                <div className="mt-20">
                  <div className="text-medium leading-loose text-jci-off-black text-left columns-1 md:columns-2 gap-10">
                    We work daily to exceed our clients' expectations, meeting deadlines and
                    presenting the best solutions for each project. To undertake this commitment,
                    the motivation of our teams is to analyse each project critically and
                    creatively, always oriented to the best solution. The personal and professional
                    development of our employees is the way to reach the best solutions, surprising
                    and surpassing all challenges with confidence and ambition.
                  </div>
                </div>
              </div>
            </div>
                ...
                <div className="flex flex-wrap gap-8 md:gap-0">
                  <div className="mr-20">
                    ...
                    <div className="md:text-medium text-black text-left uppercase max-w-44">
                      <p className="mr-0">
                        <strong>Years</strong> of proven experience
                      </p>
                    </div>
                  </div>
