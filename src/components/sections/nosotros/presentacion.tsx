...
export default function Presentacion() {
    return (
        <section className="relative z-[4] overflow-hidden">
            <div className="block">
                <div className="relative z-[1] mx-auto md:w-[calc(676px + 50vw)]">
                    <div className="flex items-center justify-center">
                        <div className="relative w-[1156px] py-[80px] px-[98px] pb-[120px] bg-white">
                            ...
                            <div className="absolute right-[50px] bottom-[35%] rotate-90 origin-bottom-right">
                ...
                <div className="relative bg-gray-50">
                    <div className="relative z-10 mx-auto">
                        <div className="flex justify-center">
                            ...
                            <div className="flex flex-grow-2 flex-shrink items-center justify-center relative mb-[-120px] translate-y-[-120px]">
                                <Image
                                    src="/images/icon-seta-down-big.svg"
                                    alt=""
                                    width={500}
                                    height={500}
                                    className="relative w-[120px] object-cover m-16"
                                />
                            </div>

                            <div className="relative overflow-hidden mb-[-120px] bg-purple-300" style={{ width: "1182px", height: "664px" }}>
