            ...
            <div className="relative max-w-6xl px-8 md:mx-auto">
                <div className="flex flex-col lg:flex-row gap-24 items-center justify-between">
                    ...
                    <div>
                        <div className="flex">
                            {/* Texto Vertical */}
                            <div className="hidden lg:block absolute top-0 left-3 translate-x-[-50%] translate-y-[-50%] -rotate-90 origin-bottom-right">
                            ...
                            <div className="relative lg:ml-44">
                                ...
                                <div className="mt-8">
                                    <div className="flex flex-col gap-3 text-gray-700 text-left text-base leading-[1.78]">
