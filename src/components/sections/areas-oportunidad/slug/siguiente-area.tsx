                                ...
                                <div className="mt-2">
                                    <div className="flex flex-col md:flex-row gap-2 md:items-center">
                                        ...
                                        <div className="flex flex-col">
                                            <h2 className="text-3xl md:text-4xl font-light text-left leading-[1.33] tracking-normal text-jci-black max-w-4xl">
                                                Siguiente Área
                                            </h2>
                                            <h2 className="text-3xl md:text-4xl font-bold not-italic text-left leading-[1.33] tracking-normal text-jci-black max-w-4xl">
                                                {nextArea.title}
                                            </h2>
                                        </div>
