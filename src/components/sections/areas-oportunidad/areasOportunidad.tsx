      ...
      <div className="my-20">
        <div className="flex flex-col">
          <div className="relative block md:flex flex-col md:flex-row justify-start">
            ...
            {/* Contenido */}
            <div className="relative w-full h-auto md:w-1/2 xl:w-1/3 overflow-hidden md:min-h-[632px] p-20 bg-white">
              <div>
                <div className="mt-0">
                ...
                <div className="mt-5">
                  <div className="text-md font-normal not-italic text-left leading-[1.78] tracking-normal text-jci-gray max-w-[372px]">
                    Martifer Metallic Constructions is a globally recognised player in the sector.
                    It provides global and innovative engineering solutions in the segments of
                    metallic constructions, aluminium and glass façades, and oil & gas.
                  </div>
                </div>
              </div>
              ...
              <div className="mt-5">
                ...
                <Link href="/areas-oportunidad" className="">
                  <div className="relative block transition-all duration-400">
                    <div className="flex pt-4 pb-0">
                      ...
                      <div className="sc-f6462093-2 iDznfc">
                        <i className="icon-icon-seta-dir-BTs"></i>
                      </div>
                    </div>
                  </div>
                </Link>
