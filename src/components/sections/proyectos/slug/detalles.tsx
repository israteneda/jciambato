...
export default function Detalles({ proyecto }: { proyecto: Proyecto }) {

    return (
        <section className="relative bg-transparent overflow-hidden" aria-labelledby={`proyecto-${proyecto.slug}-heading`}>

            <div>
                <div className="h-[640px] md:h-80"></div>

                <div className="pt-44 absolute top-0 left-0 right-0 z-20">
                    <div className="relative z-10 bg-transparent max-w-6xl mx-auto">
                        <Link
                            href="/proyectos"
