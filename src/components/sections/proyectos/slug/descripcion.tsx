                    ...
                    <div className="relative top-[-140px] mb-[-140px] z-20">
                        <div className="relative bg-white mx-auto max-w-7xl">
                            <div className="p-8 md:pt-20 md:p-20 w-full box-border">
                                ...
                                <div className="mt-8">
                                    <h2 className="text-3xl md:text-5xl font-bold leading-[1.33] text-jci-off-black max-w-[862px] text-left sm:text-[calc(28.8px+1vw)]">
                                        {proyecto.titulo}
                                    </h2>
                                </div>
                                ...
                                <div className="mt-10 md:mt-20">
                                    ...
                                    <div className="border-t border-t-gray-200">
                                        <div className="flex flex-col md:flex-row py-[23px] border-a border-a-gray-200">
                                            <div className="leading-[1.33] text-[18px] text-jci-black md:w-[30%]">Director</div>
