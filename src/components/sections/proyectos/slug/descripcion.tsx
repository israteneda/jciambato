                                ...
                                <div className="mt-10 md:mt-20">
                                    <div className="border-t border-t-gray-200">
                                        <div className="flex flex-col md:flex-row py-[23px] border-a border-a-gray-200">
                                            ...
                                            <div className="leading-[1.33] text-medium md:text-[18px] text-jci-off-black md:w-[70%] md:pl-[20px]">{proyecto.estado}</div>
                                        </div>
                                    </div>
                                    <div className="border-t border-t-gray-200 w-full">
                                        <div className="flex flex-col md:flex-row py-[23px] border-a border-a-gray-200 w-full">
                                            <div className="leading-[1.33] text-[18px] text-jci-black md:w-[30%]">Área de Oportunidad</div>
                                            <div className="leading-[1.33] text-medium md:text-[18px] text-jci-off-black md:w-[70%] md:pl-[20px]">{proyecto.area_oportunidad}</div>
                                        </div>
                                    </div>
                                    <div className="border-t border-t-gray-200">
                                        <div className="flex flex-col md:flex-row py-[23px] border-a border-a-gray-200">
                                            <div className="leading-[1.33] text-[18px] text-jci-black md:w-[30%]">Director/a</div>
                                            <div className="leading-[1.33] text-medium md:text-[18px] text-jci-off-black md:w-[70%] md:pl-[20px]">{proyecto.director}</div>
                                        </div>
                                    </div>
                                    <div className="border-t border-t-gray-200">
                                        <div className="flex flex-col md:flex-row py-[23px] border-a border-a-gray-200">
                                            <div className="leading-[1.33] text-[18px] text-jci-black md:w-[30%]">Subdirector/a</div>
                                            <div className="leading-[1.33] text-medium md:text-[18px] text-jci-off-black md:w-[70%] md:pl-[20px]">{proyecto.subdirector}</div>
                                        </div>
                                    </div>
                                    <div className="border-t border-t-gray-200">
                                        <div className="flex flex-col md:flex-row py-[23px] border-a border-a-gray-200">
