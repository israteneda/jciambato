                    ...
                    <div className="flex flex-col gap-10">
                      <article>
                        ...
                        <ul className="my-2 space-y-3">
                          <li className="flex items-start">
                            ...
                            <span>
                              <strong>Contenidos:</strong> Los textos, imágenes, logotipos, diseños
                              y demás contenidos del sitio web son propiedad de JCI Ambato o han
                              sido cedidos con autorización por JCI Ecuador y JCI Internacional, a
                              través de sus departamentos de comunicación. Estos contenidos están
                              protegidos por las leyes de propiedad intelectual de Ecuador y
                      ...
                      <article>
                        ...
                        <ul className="my-2 space-y-3">
                          <li className="flex items-start">
                            ...
                            <span>
                              <strong>Prohibiciones:</strong> Está expresamente prohibido utilizar
                              el sitio web para fines ilegales, contrarios a la moral, las buenas
                          ...
                          <li className="flex items-start">
                            ...
                            <span>
                              ...
                              utilizar el sitio de manera responsable, respetando las leyes
                              aplicables y los derechos de terceros.
                            </span>
                          </li>
                        </ul>
                      </article>
                      ...
                      <article>
                        ...
                        <ul className="my-2 space-y-3">
                          ...
                          <li className="flex items-start">
                            ...
                            <span>
                              No nos responsabilizamos por daños derivados del uso indebido del
                              sitio o de la información proporcionada, salvo que se demuestre dolo o
                      ...
                      <article>
                        ...
                        <p>
                          ...
                          aspecto del sitio web, incluyendo su contenido o funcionalidades, sin
                          previo aviso.
                        </p>
                      </article>
                    </div>
