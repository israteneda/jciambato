                  ...
                  <section>
                    <div className="flex flex-col gap-10">
                      ...
                      <article>
                        ...
                        <ul className="space-y-3 my-2">
                          <li className="flex items-start">
                            ...
                            <span>
                              Mejorar la experiencia de navegación, haciéndola más rápida y
                              eficiente.
                            </span>
                          </li>
                          <li className="flex items-start">
                      ...
                      <article>
                        ...
                        <p>
                          Usted tiene control total sobre las cookies. Puede aceptarlas, rechazarlas
                          o eliminarlas a través de la configuración de su navegador. La mayoría de
                      ...
                      <article>
                        ...
                        <p>
                          Nos comprometemos a proteger su privacidad. Las cookies que recopilan
                          datos personales se gestionan conforme a nuestra Política de Privacidad,
