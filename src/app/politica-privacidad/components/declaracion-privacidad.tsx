              ...
              <div>
                <div className="text-jci-black max-w-2xl text-left text-lg leading-[1.78] font-normal">
                  <div className="flex flex-col gap-5">
                    ...
                    <p>
                      Al utilizar nuestro sitio web (www.jciambato.org) o interactuar con JCI
                      Ambato, usted acepta el tratamiento de sus datos personales conforme a los
                      términos establecidos en esta política. Si no está de acuerdo, le recomendamos
                      abstenerse de usar nuestros servicios.
                    </p>
                  </div>
                  ...
                  <div className="my-8 rounded-lg bg-blue-50 p-6">
                    ...
                    <ul className="space-y-2">
                      ...
                      <li className="flex items-start">
                        ...
                        <span>
                          Solo los miembros autorizados cuyas funciones así lo requieran tienen
                  ...
                  <div className="mt-10 flex flex-col gap-10">
                    ...
                    <article>
                      ...
                      <p>
                        ...
                        dedicada al desarrollo del liderazgo juvenil, nos comprometemos a proteger
                        la privacidad y los derechos de los titulares de datos personales.
                      </p>
                    </article>
                      ...
                      <ul className="my-2 space-y-3">
                        ...
                        <li className="flex items-start">
                          ...
                          <span>
                            ...
                            dispositivo, dirección IP, cookies (cuando aplique)
                          </span>
                        </li>
                      </ul>
                    </article>
                    ...
                    <article>
                      ...
                      <ul className="m-2 space-y-3">
                        <li className="flex items-start">
                          ...
                          <span>
                            Gestionar su membresía en JCI Ambato y mantener la relación
                            institucional
                          </span>
                        </li>
                        <li className="flex items-start">
                          ...
                          <span>
                            Organizar y coordinar eventos, capacitaciones y actividades de
                    ...
                    <article>
                      ...
                      <ul className="m-2 space-y-3">
                        <li className="flex items-start">
                          ...
                          <span>
                            <strong>Consentimiento:</strong> Su autorización previa, libre,
                        ...
                        <li className="flex items-start">
                          ...
                          <span>
                            <strong>Cumplimiento legal:</strong> Para satisfacer obligaciones
                    ...
                    <article>
                      ...
                      <p>
                        ...
                        los plazos legales aplicables y nuestras políticas de retención documental.
                        La determinación de estos términos se basa en criterios de retención de
                    ...
                    <article>
                      ...
                      <ul className="m-2 space-y-3">
                        <li className="flex items-start">
                          ...
                          <span>
                            <strong>JCI Ecuador y JCI Internacional:</strong> Para el cumplimiento
                            de nuestras obligaciones como organización miembro de la red global JCI
                          </span>
                        </li>
                        <li className="flex items-start">
                          <span className="text-jci-teal mt-1 mr-3" aria-hidden="true">
                          ...
                          <span>
                            <strong>Proveedores de servicios:</strong> Solo cuando sea necesario
                            para el funcionamiento de nuestras actividades (ej: servicios
                            informáticos, legales)
                          </span>
                        </li>
                        <li className="flex items-start">
                          <span className="text-jci-teal mt-1 mr-3" aria-hidden="true">
                    ...
                    <article>
                      ...
                      <p>
                        ...
                        fecha de la última actualización. Le recomendamos revisar periódicamente
                        esta política para mantenerse informado sobre cómo protegemos su
                        información.
                      </p>
                    </article>
                    ...
                    <article>
                      ...
                      <p>
                        Usted podrá solicitar información o aclaraciones sobre el tratamiento que
                        JCI Ambato lleva a cabo con respecto a sus datos personales, enviando su
                        consulta a través de los canales de contacto establecidos en esta política.
                      </p>
                    </article>
