      ...
      <div className="max-w-6xl mx-8 md:mx-20 lg:mx-auto">
        ...
        <header className="text-start mb-12">
          ...
          <p className="text-lg text-gray-600 mt-2 max-w-3xl">
            Formar parte de JCI Ecuador eleva el impacto de los miembros locales a escenarios
            nacionales e internacionales. Colaboran en <strong>iniciativas de alto alcance</strong>,{" "}
            <strong>conectan con líderes globales</strong> y{" "}
            <strong>participan en proyectos internacionales</strong> que impulsan soluciones
            innovadoras, fomentando el intercambio cultural y el compromiso con los valores de la
            JCI.
          </p>
        </header>
        ...
        {/* Miembros Grid */}
        <div
          className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-4 gap-x-8 gap-y-12"
          role="list"
