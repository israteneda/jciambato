      ...
      <div className="max-w-6xl mx-8 md:mx-20 lg:mx-auto">
        ...
        <header className="text-start mb-12">
          ...
          <p className="text-lg text-gray-600 mt-2 max-w-3xl">
            Son agentes de cambio apasionados que transforman comunidades mediante proyectos
            dinámicos, fomentando <strong>liderazgo</strong>, <strong>emprendimiento</strong> y{" "}
            <strong>acción comunitaria</strong> para generar un impacto positivo y sostenible a
