...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: `${process.env.NEXT_PUBLIC_SITE_URL || "https://jciambato.org"}/noticias-eventos`,
    type: "website",
    images: [
      {
        url: `${process.env.NEXT_PUBLIC_SITE_URL || "https://jciambato.org"}/images/noticias_eventos/noticias-eventos-og.jpg`,
        width: 1200,
        height: 630,
