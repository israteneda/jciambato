  ...
  return (
    <section className="relative z-10">
      <div className="py-14 md:py-28 bg-gray-200">
        <div className="max-w-6xl mx-8 sm:mx-20 lg:mx-auto">
          {/* Titulo */}
          <header>
            <div className="text-jci-gold text-xs leading-2 font-bold uppercase">Nuestro ADN</div>
          ...
          <div className="mt-14 md:mt-28">
            {/* Contenedor Padre */}
            <div
              className="grid grid-cols-1 md:grid-cols-2 grid-rows-3 gap-5 max-w-4xl mx-auto"
              role="list"
