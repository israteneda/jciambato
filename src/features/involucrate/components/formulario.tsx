                ...
                <header>
                  ...
                  <div className="mt-6">
                    <h2
                      ...
                      className="text-jci-black max-w-92.5 text-left text-4xl leading-[1.17] font-bold tracking-normal not-italic lg:text-5xl"
                    >
                  ...
                  <div className="mt-6">
                    <p className="text-jci-black max-w-92.5 text-left text-[18px] leading-8 font-normal tracking-normal not-italic">
                      Si deseas contactarnos, por favor completa el formulario o envíanos un correo
                      a{" "}
                      <a
