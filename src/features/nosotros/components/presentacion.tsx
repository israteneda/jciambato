  ...
  return (
    <Section className="py-0 md:py-0" aria-labelledby="presentacion-heading">
      <div className="block overflow-x-clip">
        {/* Presentación */}
        <div className="relative mx-auto bg-white md:max-w-[calc(676px+50vw)]">
          <div className="relative w-full px-8 pt-20 pb-30 md:px-24 lg:max-w-350">
            <div className="relative">
              <div className="w-full">
                <p className="text-jci-gray text-xs leading-[1.85] font-bold tracking-normal uppercase not-italic">
                  Conócenos mejor
                </p>
                <div className="mt-8 w-full md:max-w-225">
                ...
                <div className="mt-16 md:mt-20">
                  <div className="text-jci-black columns-1 gap-10 space-y-4 text-justify text-base leading-loose md:columns-2 md:text-left">
                    <p>
                      ...
                      , una organización sin fines de lucro fundada en 1915, que hoy conecta a más
                      de 150.000 jóvenes líderes en más de 100 países.
                    </p>
                    <p>
                      ...
                      , una red que agrupa a los capítulos locales presentes en diversas ciudades
                      del país, todos comprometidos con una misma misión: empoderar a los jóvenes
                      para que sean ciudadanos activos y agentes de cambio positivo.
                    </p>
                    <p>
                    ...
                    <p>
                      ...
                      <strong>colaboración internacional</strong>. Cada miembro de JCI Ambato se
                      forma como un líder ético, creativo y comprometido con soluciones sostenibles,
                      alineadas con los Objetivos de Desarrollo Sostenible de las Naciones Unidas.
                    </p>
                    <p>
                      Hoy, JCI Ambato sigue siendo una plataforma de oportunidades para quienes
                      desean generar impacto, crecer como líderes y dejar una huella significativa
                      en su ciudad y en el mundo.
                    </p>
                  </div>
                </div>
              </div>
