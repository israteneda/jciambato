            ...
            <div className="bg-white px-8 py-20 pb-20 md:px-20">
              ...
              <div className="mt-16 md:mt-20">
                <div className="text-jci-black text-justify text-base leading-loose md:text-left">
                  ...
                  formación y proyectos, empoderamos a jóvenes líderes para generar un cambio real
                  en sus comunidades y carreras.
                </div>
              </div>
              ...
              <div className="mt-20">
                <div className="my-5 leading-loose md:p-6">
                  <p className="mb-4">
                    Nuestro enfoque está guiado por cuatro áreas de oportunidad:
                  </p>
                  <ul className="space-y-2">
                    <li className="flex items-start">
                      ...
                      <span>
                        ...
                        Impulsamos la innovación y el crecimiento mediante capacitación, networking
                        y conexiones con líderes de la industria.
                      </span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-jci-teal mt-1 mr-3" aria-hidden="true">
                      ...
                      <span>
                        ...
                        Conectamos a jóvenes líderes de más de 100 países para fomentar la
                        cooperación global y el entendimiento intercultural.
                      </span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-jci-teal mt-1 mr-3" aria-hidden="true">
              ...
              <div className="mt-5">
                <div className="text-jci-black text-justify text-base leading-loose md:text-left">
                  Al integrar estas áreas, cada experiencia en JCI fortalece a nuestros miembros
                  como agentes de cambio global. Ya sea liderando un proyecto, participando en una
                  formación o asistiendo a un evento internacional, JCI te prepara para dejar
                  huella.
                </div>
              </div>
            </div>
